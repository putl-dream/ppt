...
import { pptReviewReportSchema } from "../../../presentation-lifecycle/presentation-lifecycle-orchestrator";
 ...
 */
export const submitPptReviewTool: ToolDefinition<typeof pptReviewReportSchema, PptJobProjection> = {
